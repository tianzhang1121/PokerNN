...
class PlayerControl(object):
    def __init__(self, host, port, playerID, instance_num, ai_flag = False, ai_type = -1, weights = None, biases = None, name = 'Alice', stack = 2000):
        #corresponding table proxy
        self.server = xmlrpc.client.ServerProxy('http://0.0.0.0:' + str(8000 + 10 * instance_num))
        self.daemon = True
